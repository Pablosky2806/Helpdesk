...
<head>
    ...
    <style>
        * { font-family: 'Inter', sans-serif; }
        ...
        .auth-wrapper { width: 100%; max-width: 960px; display: flex; border-radius: 20px; overflow: hidden; box-shadow: 0 10px 40px rgba(0,0,0,0.12); min-height: 600px; }
...
<body>
    <div class="auth-wrapper">
        ...
        <div class="auth-form-area">
            <h3>Crear cuenta</h3>
            <p class="desc">Rellena los datos para registrarte en la plataforma.</p>
