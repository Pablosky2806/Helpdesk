...
<body>
    <div class="auth-wrapper">
        ...
        <div class="auth-form-area">
            <h3>Crear cuenta</h3>
            <p class="desc">Regístrate para empezar a gestionar tus tickets de soporte.</p>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-3">
                    ...
                    <input id="password" type="password" name="password"
                           ...
                           placeholder="Tu contraseña" required autocomplete="new-password">
                    @error('password')
                        <div class="invalid-feedback-custom">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="text-center my-4" style="position: relative;">
                ...
                <span style="background: #f0f2f5; padding: 0 16px; color: #6b7280; font-size: 0.85rem; position: relative;">O regístrate con</span>
            </div>

            <!-- Botón de Google -->
            <button id="google-register-btn" class="btn-google" style="width: 100%; padding: 12px; border: 1px solid #e5e7eb; border-radius: 8px; background: white; color: #374151; font-weight: 500; display: flex; align-items: center; justify-content: center; gap: 8px; transition: all 0.2s;">
